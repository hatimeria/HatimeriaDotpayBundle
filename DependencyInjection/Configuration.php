                ...
                ->arrayNode('forms')
                    ...
                    ->children()
                        ...
                        ->arrayNode('premium_tc')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('Hatimeria\DotpayBundle\Form\PremiumTcFormType')->end()
                                ->scalarNode('data_class')->defaultValue('Hatimeria\DotpayBundle\Response\PremiumTc')->end()
                                ->scalarNode('handler')->defaultValue('Hatimeria\DotpayBundle\Form\Handler\ResponseFormHandler')->end()
                            ->end()
                        ->end()
                    ->end()
